...
def send_email(name, dest, link):
    ...
    server.login("sumekagarwal123@gmail.com", "Sumek@14")
    ...
    msg['From'] = formataddr(("TEAM RESCUE", "sumekagarwal123@gmail.com"))

    # One last time add your email
    server.sendmail("sumekagarwal123@gmail.com", dest, msg.as_string())
    server.quit()