...
def send_email(name, dest, link):
    ...
    server.login("haleycarter222@gmail.com", "Pass@098")
    ...
    msg['From'] = formataddr(("TEAM RESCUE", "haleycarter222@gmail.com"))

    # One last time add your email
    server.sendmail("haleycarter222@gmail.com", dest, msg.as_string())
    server.quit()